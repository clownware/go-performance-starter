...
- ~~A secret scanner for ADR-014/ADR-015's "no hardcoded secrets" beyond structural patterns.~~ Done 2026-08-19 (#91): `adr015-no-hardcoded-secrets`, a Go-native high-signal pattern set inside adrcheck, warn per §4.
